...
/**
 * A concrete class representing married separately tax filer.
 */
public class MarriedSeparate extends GroupFiler{

  public MarriedSeparate(String taxID, ContactInfo contactInfo, Double lastYearEarnings,
