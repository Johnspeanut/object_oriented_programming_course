...
/**
 * An abstract class representing painters.
 * @author  John Peng
 * @version v1.0
 */
public class Painters extends PaintersPhotographers{
   ...
   */
  public Painters(String name, int age, String genres, ArrayList<String> awards,
